...
namespace ECS.RunCrawler
{
    ...
    public class Program
    {
        public static int Main()
        {
            ...
            HashSet<string> MoneyTags = new HashSet<string> { "credit", "economics", "business", "money", "finances", "stocks", "nasdaq", "dow", "savings", "saving", "bull", "bear", "market", "markets", "bank", "banks", "bankruptcy", "wall", "street", "loan", "loans", "saving", "stock", "quarterly", "anually", "financial", "retire","retirement","finance","refinance","repayment","investment","company","trade" };
            ...
            HashSet<string> TechTags = new HashSet<string> { "technologies", "technology","computer", "computers", "google", "apps", "apple", "amazon", "microsoft", "ai", "elon musk", "spacex", "nasa","intelligence","internet","engineer","engineering","development","programming","code","program","coding","science","intelligent","research","study","studies","stem" };
