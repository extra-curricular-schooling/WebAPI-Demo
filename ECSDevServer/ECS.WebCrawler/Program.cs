...
namespace ECS.WebCrawler
{
    ...
    class Program
    {
        static int Main(string[] args)
        {
            ...
            HashSet<string> ArtTags = new HashSet<string> { "art", "contemporary", "sculpture", "design", "architecture", "paint", "modern", "music", "renaissance", "sustainability", "play", "opera", "gallery", "moma", "abstract", "graphic", "graffiti", "picasso", "da", "vinci", "photography", "model", "portraits" };
            ...
            HashSet<string> MoneyTags = new HashSet<string> { "credit", "economics", "business", "money", "finances", "stocks", "nasdaq", "dow", "savings", "saving", "bull", "bear", "market", "markets", "bank", "banks", "bankruptcy", "wall", "street", "loan", "loans", "saving", "stock", "quarterly", "anually" };
            ...
            HashSet<string> EarthTags = new HashSet<string> { "environment", "environmental", "green", "organic", "sustainability", "smog", "toxic", "peta", "science", "protection", "biology", "conservation", "tree", "trees", "water", "levels", "level", "drought", "rain", "polar", "ice", "glaciers", "epa", "global", "warming" };
            ...
            HashSet<string> SmartTags = new HashSet<string> { "education", "school", "university", "college", "career", "careers", "degree", "masters", "student", "students", "teacher", "teachers", "professor", "professors", "daca", "kindergarten", "developmental", "develop", "science", "stem", "steam", "schools", "colleges", "universities" };
            ...
            HashSet<string> AncientTags = new HashSet<string> { "history", "ancient", "evolution", "prehistoric", "amazon", "dinosaur", "civil", "mayan", "renaissance", "egypt", "bc", "civil", "rights", "slavery", "battle", "ww1", "ww2", "ww", "war", "wall", "walls", "wars", "foreign", "myth", "norse", "greek", "cave", "neanderthals", "missing", "link", "early", "america", "americas", "native" };
            ...
            HashSet<string> MedicalTags = new HashSet<string> { "medicine", "cancer", "research", "health", "medical", "healthy", "blood", "diabetes", "chemotherapy", "chemo", "advancements", "advancement", "pills", "pharmaceutical", "pharma", "pharmaceuticals", "opiod", "habit", "addiction", "pain", "tocix", "diet", "benefits", "benefit" };
